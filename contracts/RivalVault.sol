...
// File: contracts/RivalVault.sol

pragma solidity 0.6.12;

contract RivalVault is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 rivalAtLastUserAction; // keeps track of $RIVAL deposited at the last user action
    ...
    /**
     * @notice Constructor
     * @param _token: $RIVAL token contract
    ...
    /**
     * @notice Deposits funds into the $RIVAL Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in $RIVAL)
     */
    ...
    /**
     * @notice Reinvests $RIVAL tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
     ...
     * @return Expected reward to collect in $RIVAL
     */
    function calculateHarvestRivalRewards() external view returns (uint256) {
    ...
    /**
     * @notice Withdraws from funds from the $RIVAL Vault
